...
# The actual plugin code is hosted at: https://github.com/quickbot/example-plugin
#
...
# install it.
#
# To install: quick plugin --install example_plugin
...
class ExamplePlugin < PluginFormula
  ...
  #   3. Extract it to ~/.quickbot/plugins/example_plugin/
  # ─────────────────────────────────────────────────────────────────────────────
