...
[![Plugin Registry](https://img.shields.io/badge/plugins-registry-blue.svg)](https://github.com/quickbot/QuickBot-Recipes)
[![License](https://img.shields.io/badge/license-MIT-green.svg)](LICENSE)
[![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg)](https://github.com/quickbot/QuickBot-Recipes/pulls)
[![macOS](https://img.shields.io/badge/platform-macOS-lightgrey.svg)]()

> The official plugin registry for [QuickBot](https://github.com/quickbot/quickbot) — a powerful macOS CLI automation tool.
...
├─────────────────────────────────────────────────────────────────────────┤
│                                                                          │
│  1. User runs: quick plugin --install my_plugin                         │
│                          │                                               │
│                          ▼                                               │
...
quick plugin --install plugin_name

# Install a specific version
quick plugin --install plugin_name@1.2.0

# List installed plugins
quick plugin --list

# Update a plugin
quick plugin --update plugin_name

# Remove a plugin
quick plugin --remove plugin_name
```
...
```bash
# Search the registry
quick plugin --search keyword

# Get plugin info
quick plugin --info plugin_name
```
...
> **⚠️ NOTICE**: Plugins in this registry are contributed by the community. While we review formulas, **installing community plugins may**:
>
...
- ✅ Use `quick plugin --info plugin_name` to view details first
...
| Command | Description |
|---------|-------------|
| `quick plugin --install <name>` | Install a plugin |
| `quick plugin --remove <name>` | Remove a plugin |
| `quick plugin --update <name>` | Update a plugin |
| `quick plugin --list` | List installed plugins |
| `quick plugin --search <query>` | Search registry |
| `quick plugin --info <name>` | Show plugin details |
...
<p align="center">
  Made with ❤️ by the QuickBot Community
</p>
